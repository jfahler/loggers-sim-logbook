...
```bash
git remote add encore encore://dcs-pilot-logbook-5na2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/dcs-pilot-logbook-5na2/deploys).
...
2. Navigate to Encore Cloud [Github Integration settings](https://app.encore.cloud/dcs-pilot-logbook-5na2/settings/integrations/github)
